...
func CreateAndActivateRestMockServer() {
	...
	httpmock.RegisterResponder(
		...
		httpmock.NewStringResponder(http.StatusOK, chainGetAccountResp),
	)

	httpmock.RegisterResponder(
		utils.GET, "http://localhost/v1/chain/get_info",
		httpmock.NewStringResponder(http.StatusOK, chainAPIGetInfoResp),
	)
	...
	chainGetAccountResp = `
        {
            ...
            "head_block_num": 273269383,
            "head_block_time": "2022-10-15T05:14:23.500",
            "privileged": false,
            "last_code_update": "1970-01-01T00:00:00.000",
            "created": "2018-06-10T13:04:15.000",
            "core_liquid_balance": "7255.0883 EOS",
            "ram_quota": 67988,
            "net_weight": 4503251,
            "cpu_weight": "13483146060",
            "net_limit": {
                "used": 245263,
                "available": 8227837,
                "max": 8473100
            ...
            "total_resources": {
                "owner": "teamgreymass",
                "net_weight": "450.3251 EOS",
                "cpu_weight": "1348314.6060 EOS",
                "ram_bytes": 66588
            },
            ...
            "voter_info": {
                ...
                "producers": [],
                "staked": 100202,
                "last_vote_weight": "697460718699.94543457031250000",
