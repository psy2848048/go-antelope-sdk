...
func CreateAndActivateRestMockServer() {
	...
	httpmock.RegisterResponder(
		utils.POST, "http://localhost/v1/chain/get_currency_balance",
		httpmock.NewStringResponder(http.StatusOK, openFile("chain_get_currency_balance.json")),
	)

	httpmock.RegisterResponder(
		utils.POST, "http://localhost/v1/chain/get_currency_stats",
	...
	httpmock.RegisterResponder(
		utils.POST, "http://localhost/v1/chain/get_raw_code_and_abi",
		httpmock.NewStringResponder(http.StatusOK, openFile("chain_get_raw_code_and_abi.json")),
	)

	httpmock.RegisterResponder(
		utils.POST, "http://localhost/v1/chain/get_table_by_scope",
